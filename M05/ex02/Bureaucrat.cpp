...
{
	std::cout << this->_name << " Bureaucrat Parametrized constructorr called" << std::endl;
	if (grade > 150)
...
{
	std::cout << this->_name << " Bureaucrat Copy Assignment operator called" << std::endl;
...
void Bureaucrat::executeForm(AForm const &form) const
{
	...
	{
		std::cout << this->_name << " couldn't execut " << form.getName() << " because grade too low" << std::endl;
	}
}
